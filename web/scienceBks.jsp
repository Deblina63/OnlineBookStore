...
<pre>
    ...
    <center>
<div class="tb">
    <br><font size='6' color='red'>SCIENCE BOOKS</font><hr>
    <marquee><font size='4' color='red'>BOOK DETAILS</font></marquee>
 
<%
    String q="select * from books where type='Physics'";
    String q1="select * from books where type='Chemistry'";
    String q2="select * from books where type='Maths'";
